...
const Drawer = ({ isOpen, setIsOpen }: Props) => {
  return (
    ...
    >
      <div
        className={
          ' w-4/5 p-6 left-0 flex flex-col absolute bg-gray-200 dark:bg-gray-800 h-full delay-400 duration-500 ease-in-out transition-all transform' +
      ...
      >
        ...
        >
          <XIcon className="w-4/5 h-4/5 text-blue-1100 dark:text-indigo-100" />
        </button>
