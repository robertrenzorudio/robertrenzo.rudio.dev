      ...
      <div className="flex justify-between">
        ...
        <div className="flex justify-between space-x-3">
          <a
            ...
            className="w-9 h-9 rounded-lg flex items-center justify-center hover:ring-2 ring-rose-500 transition-all"
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="w-5 h-5 fill-gray-800 dark:fill-gray-100"
            >
